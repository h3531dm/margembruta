...
def main():
    ...
    with col_mid:
        ...
        <div class="tc-box">
            ...
            <button class="tc-copy-btn" onclick="navigator.clipboard.writeText(\'{TC_CODES}\').then(()=>{{this.textContent='✓ Copiado';setTimeout(()=>{{this.textContent='Copiar'}},1500)}})">Copiar</button>
        </div>
        ''', unsafe_allow_html=True)
